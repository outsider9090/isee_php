...
//  contact-us form validation
	...
	$('#add_spec_input').click(function (e) {
		...
		valueStrIndex++;
		$('.addAttrib').append('<div class="col-6 mb-4"><label for="Attribute_name">عنوان ویژگی </label><input type="text" class="form-control" id="Attribute_name" name="attribName['+nameStrIndex+'][name]" required></div><div class="col-6 mb-4"><label for="Attribute_value">مقدار ویژگی </label><input type="text" class="form-control" id="Attribute_value" name="attribValue['+valueStrIndex+'][value]" required></div>');
	});
	...
	$('#add_doc_input').click(function (e) {
		...
		urlStrIndex++;
		$('.addDocument').append('<div class="col-md-4 col-sm-12 mb-4"><label for="Doc_type">نوع سند </label><input type="text" class="form-control" id="Doc_type" name="docType['+typeStrIndex+'][type]" required></div><div class="col-md-4 col-sm-12 mb-4"><label for="Doc_name">نام سند </label><input type="text" class="form-control" id="Doc_name" name="docName['+nameStrIndex+'][name]" required></div><div class="col-md-4 col-sm-12 mb-4"><label for="Doc_url">آدرس سند </label><input type="text" class="form-control" id="Doc_url" name="docUrl['+urlStrIndex+'][url]" required></div>');
	});
